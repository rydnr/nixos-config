{ config, lib, pkgs, ... }: {
  networking = {
    ...
    extraHosts = ''
      127.0.0.1 localhost jenkins.acm-sl.org maven.acm-sl.org
      ...
      192.168.1.25 witworks
      fd06:f14a:8df8::19 witworks

      192.168.1.26 mountain
      fd06:f14a:8df8::1a mountain

      192.168.1.30 printer
      fd06:f14a:8df8::1e mountain
    '';
